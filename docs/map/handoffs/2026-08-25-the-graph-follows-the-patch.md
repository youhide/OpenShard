...
S3's third artefact, from [`what_a_change_costs.md`](../new_map_representation/what_a_change_costs.md)
and planned as [`navigation_graph.md`'s G1](../navigation_graph.md#g1--the-graph-follows-a-patch).
...
[`what_a_change_costs.md`'s S2](../new_map_representation/what_a_change_costs.md)
whole.
