...
[`realtime_map.md`](../realtime_map.md#r2--the-third-layer-joins-the-type)'s
...
- [**R3 — a house has floors**](../realtime_map.md#r3--a-house-has-floors) is the
...
- [**R4 — statics become one run**](../realtime_map.md#r4--statics-become-one-run)
  is measured, bounded, and has its oracle already written.
- [**R5 — one install, one load**](../realtime_map.md#r5--one-install-one-load)
  is the smallest.

**What would block them:** nothing.

**What not to start:** era P, still. [`map_rebuild.md`](../map_rebuild.md)'s
