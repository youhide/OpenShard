...
| **The shove.** A player hard-blocked where UO would have let them past for 10 stamina | `Mobile.CheckShove`, which is four rules and two clilocs. Wants an owner for "may I walk into somebody" as a *gameplay* question, which is the half of the old open decision that is still open |
