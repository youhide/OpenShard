...
The last finding
[`navigation_spans.md`](../navigation_spans.md)'s *Out of scope, named* still
...
[N5](../navigation_spans.md#n5--off-mesh-links)'s own first step rather than
...
**No node of [`navigation_spans.md`](../navigation_spans.md) is open**, and what
...
[`navigation_spans.md`](../navigation_spans.md)'s *Out of scope, named*.
