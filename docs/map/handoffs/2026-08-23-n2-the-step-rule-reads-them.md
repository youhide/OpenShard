...
[`navigation_spans.md`](../navigation_spans.md)'s N2 called itself *"where the
...
Filed in [`navigation_spans.md`](../navigation_spans.md) — the first in N3's own
...
**[N3 — the search takes `Spans`](../navigation_spans.md#n3--the-search-takes-spans).**
...
[`terrain_seam.md`](../terrain_seam.md#what-one-search-costs)'s recorded run —
