...
[`navigation_spans.md`](../navigation_spans.md)'s N4 retires the **one-storey
...
Filed in [`navigation_spans.md`](../navigation_spans.md)'s *Out of scope,
named*.
...
**[N7 — the server reads the graph](../navigation_spans.md#n7--the-server-reads-the-graph)**,
inherited from [`terrain_seam.md`](../terrain_seam.md)'s F, whose precondition
