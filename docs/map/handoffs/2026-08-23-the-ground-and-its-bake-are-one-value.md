...
Not a node of [`navigation_spans.md`](../navigation_spans.md) — a repair of what
...
[`realtime_map.md`](../realtime_map.md)'s R2 refused when `Cover::meets` asked
...
[`navigation_spans.md`](../navigation_spans.md)'s own next is **N7 — the server
