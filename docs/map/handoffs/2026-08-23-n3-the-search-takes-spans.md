...
Era P's third node, in one commit. [`navigation_spans.md`](../navigation_spans.md)'s
...
[`terrain_seam.md`](../terrain_seam.md#what-one-search-costs) recorded.**
...
**[N3b — the node stops being a tile](../navigation_spans.md#n3b--the-node-stops-being-a-tile)**
...
**[N4 — regions over spans](../navigation_spans.md#n4--regions-over-spans)** is
