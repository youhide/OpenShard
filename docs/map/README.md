...
Two neighbours that deliberately did **not** move: [`design_occluders.md`](../render/design_occluders.md)
and [`design_footprints.md`](../render/design_footprints.md) are static geometry for the lighting
