# The pane router: how S0 to S8 landed, and what they found

The step-by-step record of moving all six window kinds off `App`, the findings
it turned up on the way, and the closing status. The model — what a pane is, and
what it may not reach — is [`../design_panes.md`](../design_panes.md).
