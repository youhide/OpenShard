...
|---|---|---|---|
| Colour: sRGB in, linear throughout, ACES out | ✅ shipping | — | [the phase record](evidence/2026-08-11-lighting-rebuild-phases.md), phase 1 |
...
- [`design_model.md`](design_model.md) — the model itself: the three roots, the
  target, what a fragment arrives with, and what of the geometry is measured
  rather than invented. Still the entry point for anything about light.
...
- [`evidence/2026-08-11-lighting-rebuild-phases.md`](evidence/2026-08-11-lighting-rebuild-phases.md)
  — how phases 0–8 were built, what each measured and what each got wrong. The
  account, not the queue.
- [`evidence/2026-08-11-lighting-backlog-findings.md`](evidence/2026-08-11-lighting-backlog-findings.md)
  — every finding the rebuild turned up, with the number taken for it. Read it
  for a measurement; the ranked queue is the section above.
