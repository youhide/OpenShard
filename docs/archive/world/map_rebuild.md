...
The want has not changed since [`overview.md`](../../world/research/a_map_we_can_change.md)'s
...
Track index: [`README.md`](../../world/README.md)
...
[`navigation_graph.md`](../../world/design_navigation_graph.md) means by *"built once from the
static terrain"*, what [`overlay.rs`](../../../crates/common/map/src/overlay.rs)
means by *"an overlay is not a terrain"*, and what
[`terrain_seam.md`](../../world/research/terrain_seam.md)'s node E landed as a type. What is new is
...
[`realtime_map.md`](../../world/evidence/2026-08-23-era-r-the-map-you-hold.md)'s **R2** made the **holding** of it one type
...
the argument [`navigation_spans.md`](../../world/design_spans.md) already makes for
...
| | |
|---|---|
| the block order is one type's | ✅ `LandGrid`, [`snapshot.md`](../../world/evidence/2026-08-25-one-world-one-door.md) phase 1 |
...
| our own chunk format, a base set, a shard that runs on it | ✅ [direction B](../../world/evidence/2026-08-25-seven-directions.md#b--our-own-chunk-format-and-a-uo-importer) — 7,168 chunks, 102.6 MiB, byte-identical round trip |
| a world with a history: `Patch`, `publish`, the `.ospatch` log, one CLI | ✅ [direction C](../../world/evidence/2026-08-25-seven-directions.md#c--patches-and-the-resolved-snapshot), first half |
| no trait on the search; `MapTerrain` is two borrows; one `Overlay` both ends build | ✅ [`terrain_seam.md`](../../world/research/terrain_seam.md), nodes 0 and A–E |
| the coarse graph is worth wiring up, and is wrong on raised ground | ✅ measured — [F, answered](../../world/research/terrain_seam.md#f--the-graph-nobody-reads) |
| the span census: 92.1% of columns hold no statics, deepest column is 12 | ✅ [N0](../../world/evidence/2026-08-25-the-span-layer.md#n0--the-census) |
...
| a column is a *list* of standable surfaces | ✅ [N1](../../world/evidence/2026-08-25-the-span-layer.md#n1--three-tiers) — 16.5 MiB, baked in 0.05 s, equal to `stand_surfaces` on all 29.4 M columns |
| the step rule reads them | ✅ [N2](../../world/evidence/2026-08-25-the-span-layer.md#n2--the-step-rule-reads-them) — 248,268,125 steps and two whole-facet floods, 0 disagreements |
| the search stops asking the map | ✅ [N3](../../world/evidence/2026-08-25-the-span-layer.md#n3--the-search-takes-spans) — 208 ns a node against 1,105, arrivals bit-identical |
| a column with two floors is two nodes | ✅ [N3b](../../world/evidence/2026-08-25-the-span-layer.md#n3b--the-node-stops-being-a-tile) — the node is a place to stand, and 178 arrivals round Britain were lies |
| regions over spans | ✅ [N4](../../world/evidence/2026-08-25-the-span-layer.md#n4--regions-over-spans) — the coarse graph refuses nothing the flood says is walkable, from any of five origins |
| the server reading the graph | ✅ [N7](../../world/evidence/2026-08-25-the-span-layer.md#n7--the-server-reads-the-graph) — a creature walks a route flat A\* at budget 400 refuses, from a raised origin as well as a flat one |
...
**The executable plan is [`realtime_map.md`](../../world/evidence/2026-08-23-era-r-the-map-you-hold.md)** — the commit
...
[`plan.md`](../../world/evidence/2026-08-25-seven-directions.md) and
[`snapshot.md`](../../world/evidence/2026-08-25-one-world-one-door.md) already use, and progress
belongs in neither: it goes in [`evidence/`](../../world/evidence).

### R1 — the table leaves the file reader ✔ built

**Goal.** `openshard-uofiles` reads files and does nothing else.

[`snapshot.md`](../../world/evidence/2026-08-25-one-world-one-door.md)'s phase 3 made this argument
...
- [`surfaces.rs`](../../../crates/common/movement/src/surfaces.rs) leaves too, and
  ...
  movement's question and is the seed [N1](../../world/evidence/2026-08-25-the-span-layer.md#n1--three-tiers)
...
- **The dependency rule this strikes** is written in five places —
  [snapshot.md](../../world/evidence/2026-08-25-one-world-one-door.md) three
  times, [plan.md](../../world/evidence/2026-08-25-seven-directions.md) and
  [README.md](../../world/evidence/2026-08-31-the-base-set-track.md) — as *"`openshard-map`
...
[`realtime_map.md`](../../world/evidence/2026-08-23-era-r-the-map-you-hold.md#r3--a-house-has-floors) for the node and
[`evidence/`](../../world/evidence) for the session.

The open row in
[`mechanics.md`](../../world/design_snapshot.md#open-with-what-would-close-it)
...
[direction F](../../world/evidence/2026-08-25-seven-directions.md#f--the-editor) says it is — an
...
[`realtime_map.md`](../../world/evidence/2026-08-23-era-r-the-map-you-hold.md#what-it-measures) — 40,078,758 bytes in
...
- `place_static` as an in-place tail shift **does not exist**. A builder assembles
  ...
  which is what [direction C](../../world/evidence/2026-08-25-seven-directions.md#c--patches-and-the-resolved-snapshot)
  already says a publish does. `patch::apply_op` moves onto that path.
  **Built the other way round, and the reasoning is
  [in the node](../../world/evidence/2026-08-23-era-r-the-map-you-hold.md#what-the-node-decided):** the pair stayed and
...
world is, which is [direction E](../../world/evidence/2026-08-25-seven-directions.md#e--to-the-client)
...
[`overview.md`](../../world/research/a_map_we_can_change.md) opens by saying the two ends
...
Inherited whole from [`navigation_spans.md`](../../world/design_spans.md), whose nodes,
...
- **The search's node has no z, and that turned out to be half a defect.** Asked
  ...
  [what a node is](../../world/design_spans.md#what-a-node-is-and-the-z-that-is-already-gone):
...
[`navigation_graph_efficiency_plan.md`](../../world/evidence/2026-08-23-navigation-graph-efficiency.md)'s
...
[`plan.md`](../../world/evidence/2026-08-25-seven-directions.md)'s directions:

| | |
|---|---|
| ~~**C, second half**~~ | **Built.** A running shard edits its own ground — `.tile`, `.setland`, `.addstatic`, `.rmstatic` — through [`mapedit::commit`](../../../crates/server/world/src/mapedit.rs), which is the answer to "who calls it and where in the tick": a staff verb, in the tick that read the command. The world moves before the log because applying a patch is how you find out whether it applies, and a log that refuses puts the world back. The span bake follows, and so does the coarse router now that D is built. **What is left of C is the connected client, which is E** |
| ~~**D**~~ | **Built, as S2 and S3 of [`what_a_change_costs.md`](../../../plans/world/what_a_change_costs/PLAN.md).** A *facet* revision moves for all 7,168 chunks at once, so the answer is a **carry**: `RadarCache::moved` keeps every product no touched chunk lies under, and the three facet-wide artefacts a publish used to rebuild or drop now follow it over the chunks it named — the span index (0.3 ms), `WorldMap`'s statics (0.4 ms) and the coarse graph (80 ms against 28 s). The occluder measurements, keyed to file mtimes, are the one reader with no revision at all |
| ~~**E**~~ | **Built, all five phases.** Whole chunks to our client over the `0xBF` envelope in the `0xE000` range, deflated — [`to_the_client.md`](../../world/design_chunks_to_the_client.md). The client's world is a parameter, it takes a facet it has no files for off the wire, keeps it under a `WorldId`, and is told when the shard's ground moves under it |
...
- a reader would be applying patches itself, which
  [`mechanics.md`](../../world/design_snapshot.md) forbids by name —
...
- the chunk is 64×64 and every artefact derived from terrain is already keyed to
  that grid, which is [`mechanics.md`](../../world/design_snapshot.md#chunks)'s
...
([N4's finding](../../world/design_spans.md), a *deployment* step) before a world could
...
[direction E](../../world/evidence/2026-08-25-seven-directions.md#e--to-the-client), and the classic
2D client is out of it by design: it reads its own files and does not see our
changes.

## The readers, and what they owe

[`interiors.md`](../../world/design_interiors.md), [`cutaway.md`](../../world/research/cutaway.md),
[`radar.md`](../../world/design_radar.md) and [`minimap_lod_plan.md`](../../world/design_minimap_lod.md) are not
...
| | |
|---|---|
| [`overview.md`](../../world/research/a_map_we_can_change.md) | **live** — the want, unchanged. Still the only one you must read to argue about the idea |
| [`mechanics.md`](../../world/design_snapshot.md) | **live**, minus one row: the house question is answered above |
| [`plan.md`](../../world/evidence/2026-08-25-seven-directions.md) | **live** for C–G; its Order section is superseded by the eras here |
| [`snapshot.md`](../../world/evidence/2026-08-25-one-world-one-door.md) | **the record** of A0 and A, plus the crate rule this document strikes |
| [`client_today.md`](../../world/evidence/2026-08-25-the-clients-map-today.md) | **live** — the measured backlog era R spent. Finding 6 is R4 and is spent, finding 7 was R5 and is withdrawn, finding 10 is the readers' |
| [`terrain_seam.md`](../../world/research/terrain_seam.md) | **closed.** The record of how the seam went, and where the facet-0 oracle's numbers live |
| [`navigation_spans.md`](../../world/design_spans.md) | **live** — era P in full, N0–N4 and N7 done; N5 and N6 gated |
...
| **Residency** | [direction G](../../world/evidence/2026-08-25-seven-directions.md#g--residency-and-size-deferred-on-purpose), unchanged: the working set a real session touches against the cost of a miss |
...
**Where the work stands is [`evidence/`](../../world/evidence)**, newest last — not here,
and not in the plan.
...
[N1](../../world/evidence/2026-08-25-the-span-layer.md#n1--three-tiers) and
[N2](../../world/evidence/2026-08-25-the-span-layer.md#n2--the-step-rule-reads-them) are built: the span
...
the handoffs in [`evidence/`](../../world/evidence) are where its
...
[`to_the_client.md`](../../world/design_chunks_to_the_client.md) is the plan.
