...
[`minimap_lod_plan.md`](design_minimap_lod.md), which is still the contract the
cache is built to, or [`minimap_lod_handoff.md`](evidence/2026-08-22-minimap-lod-cache.md),
...
[`new_map_representation/plan.md`](evidence/2026-08-25-seven-directions.md)'s section D
...
- The key's identity and the publish-only-complete contract — untouched; this
  is [`design_minimap_lod.md`](design_minimap_lod.md)'s first non-negotiable and
  it holds.
...
2. **The coarse pyramid is swept lazily, on the first facet-map open.** A
   ...
   [`new_map_representation/plan.md`](evidence/2026-08-25-seven-directions.md)'s section
...
When R3 lands, [`minimap_lod_handoff.md`](evidence/2026-08-22-minimap-lod-cache.md)'s three wedge
...
and never built, which is exactly [`design_frame_assembly.md`](../render/design_frame_assembly.md)'s hazard.
...
[`what_a_change_costs.md`](../../plans/world/what_a_change_costs/PLAN.md)'s S2.
