...
> **The matryoshka's routing table.** [`map_rebuild.md`](../archive/world/map_rebuild.md#the-map-in-one-type)
...
That is the whole rule, and it is the invariant [`README.md`](README.md) states
one line under the layer table:
...
- [*"A tile of ground moved — rebake, and never an overlay"*](../archive/world/map_rebuild.md#a-tile-of-ground-moved--rebake-and-never-an-overlay)
- [*"a house is a layer"*](../archive/world/map_rebuild.md#r3--a-house-is-a-layer-and-it-has-floors)
...
| the coarse graph, after N4 and P1's crossing spacing | 14.4 s (10.6 s before the spacing) |
...
facet: [`navigation_spans.md`](design_spans.md)'s N8 for the spans and
...
[`what_a_change_costs`](../../plans/world/what_a_change_costs/PLAN.md) records
115.4 ms from an earlier run of the same test.
...
- **The saving it wants already exists, and without either.** The editor's draft
  is local until Commit — see [`editor.md`](../../plans/world/map_editor/PLAN.md), slices 4 and 5: gestures
