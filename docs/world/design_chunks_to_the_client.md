...
> **Direction [E](evidence/2026-08-25-seven-directions.md#e--to-the-client)'s executable plan.** `plan.md` states
...
> client that runs.
>
> Where the work stands is [`README.md`](README.md); the session records are in
...
is out of this by design — [`design_layers.md`](design_layers.md) says so, and
...
[`map_rebuild.md`](../archive/world/map_rebuild.md#a-tile-of-ground-moved--rebake-and-never-an-overlay)
...
approach is [direction G](evidence/2026-08-25-seven-directions.md#g--residency-and-size-deferred-on-purpose)'s,
...
- **🚩 "No coarse graph" is not a thing a player can be asked to live with.**
  ...
  **What it wanted was already here.** E3 keeps the world as a base set of ours,
  ...
  see [`navigation_graph_bake.md`](reference/navigation_artifact.md).
...
[direction C's own "done"](evidence/2026-08-25-seven-directions.md#c--patches-and-the-resolved-snapshot), and the
last clause of it.
...
- ~~**A base set could store its chunks deflated.**~~ **Taken**, as the first
  third of [`what_a_change_costs.md`](../../plans/world/what_a_change_costs/PLAN.md)'s S1 — a version 2
...
- **A publish costs the window a whole facet's rebuild** — ~~and nobody has
  ...
  node of its own —
  [`navigation_spans.md`](evidence/2026-08-25-the-span-layer.md#n8--the-bake-follows-a-patch)'s
...
([handoff](evidence/2026-08-25-a-fetch-survives-the-ground-moving.md)):
