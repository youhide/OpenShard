...
> [`map_rebuild.md`](../../archive/world/map_rebuild.md)'s R1.

The executable plan for directions **A0** and **A** of
[`plan.md`](2026-08-25-seven-directions.md) — and nothing else in this track. It is worth landing on
its own: no format, no patches, no network, no editor, and every test in the
workspace passes at the end of each phase.

Parent: [`plan.md`](2026-08-25-seven-directions.md) · Track: [`README.md`](2026-08-31-the-base-set-track.md) · The measured
state it starts from: [`client_today.md`](2026-08-25-the-clients-map-today.md)
...
[`plan.md`'s A0](2026-08-25-seven-directions.md#a0--the-cell-array-becomes-a-type-that-owns-the-order),
...
is exactly the confusion [`design_pixel_spaces.md`](../../render/design_pixel_spaces.md) exists to prevent.
...
[direction B](2026-08-25-seven-directions.md#what-felucca-measures-before-the-layout-is-chosen). What
...
[direction B](2026-08-25-seven-directions.md#b--our-own-chunk-format-and-a-uo-importer) later fills
...
[`client_today.md`](2026-08-25-the-clients-map-today.md)'s finding 8 — `WorldMap` today names only a
...
*The reason is [direction C](2026-08-25-seven-directions.md#c--patches-and-the-resolved-snapshot), and
...
revision, which is [direction D](2026-08-25-seven-directions.md#d--derived-data-keyed-by-revision)'s
...
[direction D](2026-08-25-seven-directions.md#d--derived-data-keyed-by-revision), and a session that
...
which is the shape [`plan.md`](2026-08-25-seven-directions.md) already has a name for. `interiors::build`
...
That is backwards against the thing [`overview.md`](../research/a_map_we_can_change.md) asks for in its
...
[`map_rebuild.md`](../../archive/world/map_rebuild.md)'s R1, which moves `TileData` out of the
...
- ~~`openshard-map` depends on `openshard-protocol` and nothing else~~, and no
  ...
  [`map_rebuild.md`](../../archive/world/map_rebuild.md#decisions-taken-here); the path half is
...
- **The revision cannot move, so the guard is tested and not exercised.** Both
  ...
  [direction C](2026-08-25-seven-directions.md#c--patches-and-the-resolved-snapshot)'s to
...
- **The land and the statics share an index that is still two arrays.**
  ...
  [direction B](2026-08-25-seven-directions.md#b--our-own-chunk-format-and-a-uo-importer)'s to build.
...
- **Lazy chunk residency and compressing the land.**
  [Direction G](2026-08-25-seven-directions.md#g--residency-and-size-deferred-on-purpose), deferred on
...
- **One composer for the base and the entities over it.** `LiveTerrain` on the
  ...
  the diff.
- **The client-side defects in [`client_today.md`](2026-08-25-the-clients-map-today.md)** — the
...
[B](2026-08-25-seven-directions.md#b--our-own-chunk-format-and-a-uo-importer), and the state it starts
from — what was decided, and which of the left-behind items are still open — is
in the newest [handoff](.). This document is kept for its decisions,
