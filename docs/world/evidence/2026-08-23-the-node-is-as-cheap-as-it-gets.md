...
[`navigation_spans.md`](../design_spans.md)'s **baked adjacency**, which the
...
[direction C, second half](2026-08-25-seven-directions.md#c--patches-and-the-resolved-snapshot) —
...
[`terrain_seam.md`](../research/terrain_seam.md)'s D; what is open is **who calls it and
where in the tick**.
...
[`design_frame_assembly.md`](../../render/design_frame_assembly.md)'s frame assembled by hand in seven places.
