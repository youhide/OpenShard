...
The executable half of [`map_rebuild.md`](../../archive/world/map_rebuild.md)'s era R. That document
...
[`plan.md`](2026-08-25-seven-directions.md) records intent and
[`snapshot.md`](2026-08-25-one-world-one-door.md) was the plan being executed;
`map_rebuild.md` records the eras and this is the plan being executed now.
Progress does not go in either — it goes in
[the session records beside this one](.).
...
- **A bake cannot reach the live layer.** It takes `world.snapshot()`, which is
  ...
  through. [`map_rebuild.md`](../../archive/world/map_rebuild.md)'s invariant becomes a borrow rather
  than a rule.
...
The line is [`snapshot.md`](2026-08-25-one-world-one-door.md)'s own, quoted
...
parser. It is also the seed [N1](2026-08-25-the-span-layer.md#n1--three-tiers) builds
...
- The **packed four-byte record** is not in this node. It changes accessors from
  ...
  [N3](2026-08-25-the-span-layer.md#n3--the-search-takes-spans)'s measurement to say
...
[`overview.md`](../research/a_map_we_can_change.md)'s opening complaint: the two
...
which is [direction E](2026-08-25-seven-directions.md#e--to-the-client)
...
**[Era P](../../archive/world/map_rebuild.md)**, because era R is over. R5 is struck — the reasoning
...
Progress goes in [the session records beside this one](.), not here.
