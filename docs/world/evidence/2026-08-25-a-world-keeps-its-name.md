...
S1 of [`what_a_change_costs.md`](../../../plans/world/what_a_change_costs/PLAN.md), which is the plan
...
- The radar cache, the navigation bake and the building flood swap
  ...
  closes [`radar.md`](../design_radar.md)'s 10.2, which names the shard that gives
