...
[`snapshot.md`](2026-08-25-one-world-one-door.md) is done. Both of its phases are merged, and the
...
[`snapshot.md`](2026-08-25-one-world-one-door.md) named — eight in `client/render`'s interiors
...
[`snapshot.md`](2026-08-25-one-world-one-door.md) with their reasoning.
...
- **The prediction sits with the snapshot's owner, not on the socket thread** —
  ...
  [direction C](2026-08-25-seven-directions.md#c--patches-and-the-resolved-snapshot) is worse than a
...
- **The revision guard is beside the mtime key, not instead of it.** Replacing
  the key is [direction D](2026-08-25-seven-directions.md#d--derived-data-keyed-by-revision), and a
...
By [`plan.md`'s order](2026-08-25-seven-directions.md#order), direction B — our own chunk format and
...
in [`snapshot.md`](2026-08-25-one-world-one-door.md)'s left-behind lists: give `LandGrid`'s transitions their first caller, which is what turns
