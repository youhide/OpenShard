...
other end of. [`navigation_spans.md`](../design_spans.md)'s N7 spends what
...
[`terrain_seam.md`](../research/terrain_seam.md)'s **F**, which asked *wire it up or stop
...
**Nothing in [`navigation_spans.md`](../design_spans.md) is open.** N0–N4,
