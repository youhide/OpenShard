...
any code. What survived is in [`mechanics.md`](../design_snapshot.md); what was
...
Direction A in [`plan.md`](2026-08-25-seven-directions.md): one revisioned snapshot that every
