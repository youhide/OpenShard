...
> [`realtime_map.md`](2026-08-23-era-r-the-map-you-hold.md)'s R4 and is **spent**; finding 7 was
...
120,744 non-empty blocks). [`plan.md`](2026-08-25-seven-directions.md) lists *who* reads the world;
...
1. **The world map draws at LOD 0.** [`render_passes.rs:636`](../../../crates/client/app/src/render_passes.rs#L636)
   ...
   > **Spent, with findings 2 and 3, by [`radar.md`](../design_radar.md)'s R0–R8.** A
...
4. **The revision dimension has no production writer.** `set_revision` and
   ...
   > **Half spent** by [E4](../design_chunks_to_the_client.md#e4--a-publish-reaches-a-connected-client):
...
6. **`Vec<Vec<StaticItem>>` is 120,744 allocations.** Sized and weighed under
   [`plan.md`'s direction B](2026-08-25-seven-directions.md#what-felucca-measures-before-the-layout-is-chosen):
...
7. **Both ends load the same install separately** —
   ...
   > **Withdrawn.** [R5](2026-08-23-era-r-the-map-you-hold.md#r5--one-install-one-load)
   ...
   > half stands and belongs to [direction E](2026-08-25-seven-directions.md#e--to-the-client): the
...
- It is an argument about chunk size, recorded in
  [`mechanics.md`](../design_snapshot.md#chunks): at 8×8 a castle is sixteen chunks and
...
> **Spent.** [R4](2026-08-23-era-r-the-map-you-hold.md#r4--statics-become-one-run) made them one
