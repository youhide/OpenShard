...
> same mistake, and [`navigation_spans.md`](../design_spans.md)'s **N4 is
...
- [ ] Phase 3: second hierarchy level. **The facet-0 route set exists now** —
  ...
  [`terrain_seam.md`](../research/terrain_seam.md#0--the-oracle-) — and it did not settle
...
[`terrain_seam.md`](../research/terrain_seam.md#0--the-oracle-).
...
- 🚩 **`NavigationGraph::build` samples one height per tile, and that height is
  ...
  graph at all — see [`terrain_seam.md`](../research/terrain_seam.md#f--the-graph-nobody-reads)'s
  node F. **✅ Fixed by [`navigation_spans.md`](../design_spans.md)'s N4**: the
