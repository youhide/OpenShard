...
| | |
|---|---|
| [`to_the_client.md`](../design_chunks_to_the_client.md) | E's executable plan: the measurements, the decisions, five phases E0–E4 with a "done" each, and what it must not do |
...
[`to_the_client.md`](../design_chunks_to_the_client.md): `0xE002` a request naming chunks,
