...
[`new_map_representation/`](../../../docs/world/evidence/2026-08-31-the-base-set-track.md): a Game Master
...
What this plan is open for is the rest of that cut: continuous drag strokes
instead of click-sized dabs, an art-composited static preview instead of a
coloured geometry overlay, smooth, stamps and rebase. Where the cut stands is
[`docs/world/README.md`](../../../docs/world/README.md), not here.
