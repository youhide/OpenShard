...
| [`docs/streamed_world_map.md`](docs/streamed_world_map.md) | The map we own: a UO-importable chunk format, immutable base chunks, durable terrain/static patches, and the resolved chunks streamed to our client. |
