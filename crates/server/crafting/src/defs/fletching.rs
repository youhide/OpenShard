//! DefBowFletching's recipes, as core data.
//!
//! The table itself is [`data/fletching.json`], generated once from ServUO by
...
//! are in tenths.
//!
//! [`data/fletching.json`]: ../../../data/fletching.json
...
include!(concat!(env!("OUT_DIR"), "/fletching.rs"));
