...
//!
//! The table itself is [`data/blacksmithy.json`], generated once from ServUO by
...
//! are in tenths.
//!
//! [`data/blacksmithy.json`]: ../../../data/blacksmithy.json
...
include!(concat!(env!("OUT_DIR"), "/blacksmithy.rs"));
