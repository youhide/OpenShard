...
/// step invalidate terrain — the one thing `docs/world/design_minimap_lod.md` exists to
...
impl RadarOverlayRenderer {
    ...
    /// world through that part — a hole, which `docs/world/design_minimap_lod.md`'s
