...
pub use walk::{
    Heading, Intent, Lean, Refusal, Walk, Walker, arrival_z, can_fit, can_stand, can_step,
    direction_toward, heading_toward, intend, line_tiles, sight_clear, step_allowed, step_from,
    steps_out_of,
};
